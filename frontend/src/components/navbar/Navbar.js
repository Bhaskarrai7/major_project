                ...
                <div className='modal-dialog'>
                  <div className='modal-content'>
                    ...
                    <div className='modal-footer'>
                      <a
                        className='mr-5'
                        href='https://github.com/Bhaskarrai7'
                        target='_'>
                        developed by: Bhaskar Rai & Sanket Aggarwal
                      </a>
                      <button
                        type='button'
                        className='btn btn-danger'
            ...
            {true ? (
              <li className='nav-item dropdown'>
                ...
                <div className='dropdown-menu'>
                  ...
                  <a className='dropdown-item' to='/addcrop'>
                    Add product
                  </a>
                  <a className='dropdown-item' to='/crops'>
                    Crops
                  </a>
